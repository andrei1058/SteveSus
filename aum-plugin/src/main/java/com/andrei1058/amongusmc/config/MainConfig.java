package com.andrei1058.amongusmc.config;
...
import com.andrei1058.amongusmc.config.properties.LocationProperty;
...
public class MainConfig implements SettingsHolder {
    ...
    @Comment({"Server type defines the way you want to run the plugin.",
            ...
            "BUNGEE - if you want to run multiple arenas on this server without a lobby. Players will join from a remote server using AmongUsMc-Proxy plugin.",
