package com.andrei1058.amongusmc;

import co.aikar.taskchain.BukkitTaskChainFactory;
import co.aikar.taskchain.TaskChain;
import co.aikar.taskchain.TaskChainFactory;
import com.andrei1058.amongusmc.api.AmongUsMcAPI;
...
import com.andrei1058.amongusmc.command.SlaveCommandManager;
import com.andrei1058.amongusmc.command.filter.CommandFilter;
...
import com.andrei1058.amongusmc.hook.papi.PlaceholderAdditions;
...
@Plugin(name = "AmongUsMc", version = "1.0-alpha")
...
public class AmongUsMc extends JavaPlugin implements AmongUsMcAPI {

    private static AmongUsMc INSTANCE;
    ...
    public void onDisable() {
        ...
        AmongUsMc.debug("Took " + (System.currentTimeMillis() - startTime) + "ms to disable this plugin.");
    }

    public static void debug(String msg) {
        if (ServerManager.getINSTANCE().isDebuggingLogs()) {
            AmongUsMc.getInstance().getLogger().info(ChatColor.AQUA + "[DEBUG] " + msg);
        }
    }
    ...
    public static AmongUsMc getInstance() {
        return INSTANCE;
    }
