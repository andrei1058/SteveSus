package com.andrei1058.amongusmc.setup.command;
...
public class SetupCommand extends FastSubRootCommand {
    ...
    public SetupCommand(String name) {
        ...
        withPermissions(new String[]{CommonPermission.ALL.get(), CommonPermission.ADMIN.get()})
                ...
                .withHeaderContent("&1|| &3" + AmongUsMc.getInstance().getName() + " &7 - Setup Commands")
                .withHeaderHover("&7By " + Arrays.toString(AmongUsMc.getInstance().getDescription().getAuthors().toArray()) + "\n&av" + AmongUsMc.getInstance().getDescription().getVersion())
