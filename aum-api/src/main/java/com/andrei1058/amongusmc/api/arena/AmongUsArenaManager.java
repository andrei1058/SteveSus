package com.andrei1058.amongusmc.api.arena;
...
public interface AmongUsArenaManager {
     ...
     * Triggers {@link com.andrei1058.amongusmc.api.event.GameInitializedEvent}.
     *
     ...
     * This will trigger {@link com.andrei1058.amongusmc.api.world.WorldAdapter#onArenaEnableQueue(String, Arena)}
     *
     ...
     * your arena using {@link AmongUsArenaManager#startArenaFromTemplate(String)} or if you used {@link AmongUsArenaManager#addToEnableQueue(Arena)} before.
     *
     ...
     * Will trigger {@link com.andrei1058.amongusmc.api.world.WorldAdapter#onArenaDisable(Arena)}.
