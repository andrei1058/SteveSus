...
public enum Message {
    ...
    EXCLUSION_RESULT_FORMAT_EXCLUSION_DRAW(false, "vote-result-chat-format-draw", "&b&lNo one was ejected! (Draw)"),
    ...
    EXCLUSION_RESULT_TITLE_DRAW(false, "vote-result-title-draw", " "),
    EXCLUSION_RESULT_SUBTITLE_SKIPPED(false, "vote-result-subtitle-draw", "&6No one was ejected!"),
    EXCLUSION_RESULT_SUBTITLE_DRAW(false, "vote-result-subtitle-skipped", "&6No one was ejected!"),
