...
public enum LegacyPlayerColor implements PlayerColorAssigner.PlayerColor {
     ...
     * @param uniqueIdentifier   is used to identify this color. It is used as well as part of translation path (Ex: {@link com.andrei1058.stevesus.api.locale.Message#COLOR_NAME_PATH_} + legacy-color-red) and maybe more.
     */
