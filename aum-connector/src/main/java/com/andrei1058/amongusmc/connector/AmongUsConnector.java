package com.andrei1058.amongusmc.connector;
...
import com.andrei1058.amongusmc.connector.common.ConnectorCommonProvider;
import com.andrei1058.amongusmc.connector.config.ConnectorConfig;
import com.andrei1058.amongusmc.connector.hook.papi.PlaceholderAdditions;
import com.andrei1058.amongusmc.connector.language.LanguageManager;
import com.andrei1058.amongusmc.connector.listener.AdminJoinListener;
...
import com.andrei1058.amoungusmc.connector.api.ConnectorAPI;
...
@Plugin(name = "AmongUsMc-Connector", version = "1.0-alpha")
...
public class AmongUsConnector extends JavaPlugin implements ConnectorAPI {
    ...
    public static void debug(String msg) {
        if (ConnectorCommonProvider.getInstance().isDebuggingLogs()) {
            AmongUsConnector.getInstance().getLogger().info(ChatColor.AQUA + "[DEBUG] " + msg);
        }
    }
